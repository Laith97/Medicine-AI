...
.perm-card{border:1px solid #eef2f7;border-radius:10px;padding:0.75rem 0.9rem;background:#fff;transition:all .15s}
.perm-card:has(input:checked){background:#eff6ff;border-color:#bfdbfe}
    ...
    <div class="container py-4">
        <div class="dashboard-header cases-header-compact">
            <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
                <div>
                    <h2><i class="fas fa-user-plus me-2"></i>Create New Sub-User</h2>
                    <p>Add a team member and configure their access permissions</p>
                </div>
        ...
        <form method="POST" action="{{ route('sub-users.store') }}">
            ...
            <div class="row g-4">
                <div class="col-lg-8">
                    <div class="table-card">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" required placeholder="e.g., Sarah Johnson">
                                @error('name')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="email" class="form-label note-label">Email Address <span class="text-danger">*</span></label>
                                <input type="email" class="form-control @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" required placeholder="sarah@clinic.com">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="tel" class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone" value="{{ old('phone') }}" placeholder="+1 555 0100">
                    ...
                    <div class="table-card">
                        <div class="section-head-modern"><div class="d-flex align-items-center gap-3"><div class="head-icon" style="background:#eff6ff!important;color:#2563eb!important;border-color:#dbeafe!important"><i class="fas fa-lock"></i></div><div><h5>Login Credentials</h5><p>Password for sub-user</p></div></div></div>
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="password" class="form-label note-label">Password <span class="text-danger">*</span></label>
                                <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password" required>
                                @error('password')<div class="invalid-feedback">{{ $message }}</div>@enderror
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="password_confirmation" class="form-label note-label">Confirm Password <span class="text-danger">*</span></label>
                ...
                <div class="col-lg-4">
                    <div class="table-card">
                        <div class="section-head-modern"><div class="d-flex align-items-center gap-3"><div class="head-icon"><i class="fas fa-bolt"></i></div><div><h5>Actions</h5><p>Save</p></div></div></div>
                        <div class="d-grid gap-2">
                            <button type="submit" class="doctor-btn doctor-btn-primary" style="justify-content:center"><i class="fas fa-user-plus me-2"></i>Create Sub-User</button>
                            <a href="{{ route('sub-users.index') }}" class="doctor-btn doctor-btn-outline" style="justify-content:center"><i class="fas fa-arrow-left me-2"></i>Cancel</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="table-card">
                        <div class="section-head-modern"><div class="d-flex align-items-center gap-3"><div class="head-icon" style="background:#f0fdf4!important;color:#059669!important;border-color:#a7f3d0!important"><i class="fas fa-shield-halved"></i></div><div><h5>Access Permissions</h5><p>Choose features this sub-user can access</p></div></div>
                                        ...
                                        @foreach($permissions as $permission)
                                            <div class="col-md-6 col-lg-4">
                                                <label class="perm-card d-flex gap-2" for="permission_{{ $permission->id }}" style="cursor:pointer">
                                                    <input class="form-check-input mt-1" type="checkbox" name="permissions[]" value="{{ $permission->id }}" id="permission_{{ $permission->id }}" {{ in_array($permission->id, old('permissions', [])) ? 'checked' : '' }}>
