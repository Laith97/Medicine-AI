            ...
            <div class="mb-4">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">Edit {{ $subUser->name }}</li>
                    </ol>
                </nav>
                <h1 class="h3 mb-1">Edit Sub-User</h1>
                <p class="text-muted">Update {{ $subUser->name }}'s information and permissions</p>
            </div>
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('sub-users.update', $subUser) }}">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror" 
                                           id="name" name="name" value="{{ old('name', $subUser->name) }}" required>
                                    @error('name')
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="tel" class="form-control @error('phone') is-invalid @enderror" 
                                           id="phone" name="phone" value="{{ old('phone', $subUser->phone) }}">
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="mb-4">
                            ...
                            @php
                                $currentPermissions = $subUser->permissions->pluck('id')->toArray();
                            @endphp
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Update Sub-User
                            </button>
                        </div>
                    </form>
                </div>
