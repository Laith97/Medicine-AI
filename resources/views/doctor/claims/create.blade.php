        ...
        <div class="col-12">
            <div class="dashboard-header">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2><i class="fas fa-plus-circle me-2"></i>Create New Insurance Claim</h2>
                        <p class="text-muted mb-0">Fill in the claim details below</p>
                    </div>
                        ...
                        <div class="card mt-4">
                            <div class="card-body">
                                <div class="d-grid gap-2">
                                    ...
                                    <a href="{{ route('doctor.claims.index') }}" class="btn btn-outline-secondary">
                                        Cancel
                                    </a>
                                </div>
                            </div>
