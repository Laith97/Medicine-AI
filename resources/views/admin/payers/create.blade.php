...
<div class="row">
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="h3 mb-0">Add New Payer</h1>
                <p class="text-muted">Create a new insurance payer configuration</p>
            </div>
                ...
                <form action="{{ route('admin.payers.store') }}" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('payer_id') is-invalid @enderror"
                                   id="payer_id" name="payer_id" value="{{ old('payer_id') }}" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" class="form-control @error('contact_info.email') is-invalid @enderror"
                                   id="contact_info_email" name="contact_info[email]" value="{{ old('contact_info.email') }}">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" class="form-control @error('contact_info.phone') is-invalid @enderror"
                                   id="contact_info_phone" name="contact_info[phone]" value="{{ old('contact_info.phone') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control @error('contact_info.address') is-invalid @enderror"
                                  id="contact_info_address" name="contact_info[address]" rows="3">{{ old('contact_info.address') }}</textarea>
                    ...
                    <div class="row">
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('settings.processing_time_days') is-invalid @enderror"
                                   ...
                                   value="{{ old('settings.processing_time_days', 30) }}" min="1" max="365">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <select class="form-select @error('settings.requires_pre_auth') is-invalid @enderror"
                                ...
                                <option value="0" {{ old('settings.requires_pre_auth', '0') == '0' ? 'selected' : '' }}>No</option>
                                <option value="1" {{ old('settings.requires_pre_auth', '0') == '1' ? 'selected' : '' }}>Yes</option>
                            </select>
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <input type="number" class="form-control @error('settings.auto_approve_under') is-invalid @enderror"
                                   ...
                                   value="{{ old('settings.auto_approve_under') }}" min="0" step="0.01">
                    ...
                    <div class="d-flex justify-content-end gap-2">
                        <a href="{{ route('admin.payers.index') }}" class="btn btn-outline-secondary">Cancel</a>
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>Create Payer
                        </button>
                    </div>
                </form>
            </div>
