    ...
    <div class="row">
        <div class="col-12">
                ...
                <div>
                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item"><a href="{{ route('hospital-admin.departments.show', $department) }}">{{ $department->name }}</a></li>
                            <li class="breadcrumb-item active">Edit</li>
                        </ol>
                    </nav>
                </div>
                <a href="{{ route('hospital-admin.departments.show', $department) }}" class="btn btn-secondary">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('hospital-admin.departments.update', $department) }}">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" class="form-control @error('capacity') is-invalid @enderror" 
                                           id="capacity" name="capacity" value="{{ old('capacity', $department->capacity) }}" min="0">
                                    @error('capacity')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
