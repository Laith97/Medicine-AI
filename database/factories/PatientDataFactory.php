...
class PatientDataFactory extends Factory
{
    ...
    public function definition()
    {
        return [
            ...
            'visit_type' => $this->faker->randomElement(['routine', 'urgent', 'follow_up']),
            ...
            'mood_behavior' => $this->faker->randomElement(['Calm', 'Agitated', 'Anxious']),
            ...
            'pupil_reactivity' => $this->faker->randomElement(['PERRLA', 'Sluggish', 'Fixed']),
            'vision_issues' => $this->faker->boolean(),
            'hearing_issues' => $this->faker->boolean(),
            'oral_findings' => $this->faker->optional()->sentence(),
            'orientation_level' => $this->faker->randomElement(['Oriented x4', 'Oriented x3', 'Disoriented']),
            'limb_strength' => $this->faker->randomElement(['Equal', 'Weak Left', 'Weak Right']),
            'reflexes' => $this->faker->randomElement(['Normal', 'Hyperactive', 'Hypoactive']),
            ...
            'capillary_refill_time' => $this->faker->randomElement(['< 2s', '> 3s']),
            'abdominal_shape' => $this->faker->randomElement(['Flat', 'Distended', 'Scaphoid']),
            'bowel_sounds' => $this->faker->randomElement(['Normal', 'Hyperactive', 'Hypoactive']),
            ...
            'gait_stability' => $this->faker->randomElement(['Stable', 'Unstable', 'Requires assistance']),
            ...
            'skin_temperature' => $this->faker->randomElement(['Warm', 'Cool', 'Hot']),
